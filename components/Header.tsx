    ...
    <header>
      <div className='flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl'>
        ...
        <div className=' flex items-center space-x-5 flex-1 justify-end w-full'>
          ...
          <form
            action=''
            className='flex items-center space-x-5 bg-white p-2 shadow-md flex-1 md:flex-initial rounded-md'
          >
          ...
          {/* Avatar */}
          <Avatar name='Ala Ayari' round color='#0055D1' size='50' />
        </div>
      </div>
      <div className='flex items-center justify-center py-5 px-5 md:py-5'>
